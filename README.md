...
The slurm files `dst.slurm` and `alpha.slurm` run `DATA_GEN.py` and `ALPHA_GEN.py` (respectively) in a HPC shell where SLURM commands are recognized.  Modify the preamble with your credentials.  
